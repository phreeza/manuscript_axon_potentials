...
explained by the axons' anatomical structure. In particular, we show that the branchings and termonations of axons in
...
zone, in which the number of fibers decreases to zero (Figure 1A).
...
EFP responses with a cut-off frequency of 1 kHz (Figure 1B). The distribution
of maximum amplitudes of these responses are shown by the  colored contour
lines in Figure 1A and the colored traces in Figure 1B. Surrounding the
