...
can be explained by the axons' anatomical structure. In particular, the branchings and terminations of axons in their terminal zone area can lead
...
multi-compartment simulation of an axon population. We then outline the basic
