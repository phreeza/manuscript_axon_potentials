...
potential was calculated for several locations along the axon trunk (Figure
1B).
...
The most salient feature of the response traces is a biphasic deflection evoked
by the rate pulse. This deflection is visible at all locations, and its
peak-to-peak amplitude can reach a millivolt (scale indicated by the color code
in Figure 1). Close to the trunk there is also a strong high-frequency noise
...
local density of bifurcations and terminations (Figure 1F). Along the nerve
