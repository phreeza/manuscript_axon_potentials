...
generated for several locations (Figure 1B). The most salient feature of the
response traces is a biphasic deflection evoked by the rate pulse. The
deflection is visible at all locations, and its peak-to-peak amplitude is
indicated by the color code in figures 1A and 1B.
