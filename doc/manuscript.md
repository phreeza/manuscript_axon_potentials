...
the second temporal derivative of the membrane potential. These extrema of the EFP
...
positive peak preceding a negative peak. The biphasic appearance at recording
locations beyond the termination can be understood by considering the locations
of the currents along the axon. As the action potential approaches the
recording location, the majority of the currents flow at points located before
the termination, and are identical to those in the non-terminating case; the
first peak is not affected. The second and third peak of the extracellular
action potential in the non-terminating case are generated by currents close to
or after the electrode location. Because the terminating axon ends, the
currents at points after the termination are no longer present, leading to a
partial suppression of the second peak and a complete suppression of the third
peak at locations after the termination.
...
([@fig:simpletree]C). The EFP near this bifurcation also has a biphasic shape.
Although there is an initial small positive peak, the response is dominated by
the second, negative and the third, positive peak. This waveform can again be
understood by comparison to the first example containing the infinitely long
axon: The initial peak resembles the infinite case, because most of the action
potential-related currents are flowing is still within the part of the axon
before the bifurcation. As the action potential passes the bifurcation zone,
there are now several instances of the action potential, and the currents sum
up across the fibers. This leads the second and third peak to be multiplied in
size, yielding a more biphasic response. We chose to simulate several
...
which a pulse of increased activity was added. These numbers are motivated by
the early auditory system (**ref**). However, this pulse of activity could
...
To characterize the spatiotemporal dynamics of the evoked EFP, the time course of the potential
was calculated for several locations along the axon trunk. Because we first
wanted to study the effect of the rate pulse on the EFP, we low-pass filtered the
...
Surrounding the projection zone of the axon bundle, amplitudes showed the
double-lobed shape typical of a dipole.

In [@fig:bigtree]B, all the responses showed a biphasic or monophasic deflection that was elicited
by the population firing rate pulse. This deflection was visible at all
recording locations. The deflection reverses polarity in the middle of
...
the end of the projection zone, the terminations outweigh the
...
(>1 kHz) components of the response, and is thought to reflect spiking activity
...
phenomenon, while the high-frequency component is shifted in space according to
