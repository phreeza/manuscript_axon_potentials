...
of the potential was calculated for several locations along the axon trunk.
...
the projection zone of the bundle ([@fig:bigtree]B). The polarity
...
maximum response (black trace) follows the distribution of branchings and
terminations (blue histogram). 
...
quadrupolar component becomes important. For this reason we performed the same
...
before approaching each other again for high frequencies. The quadrupole moment
